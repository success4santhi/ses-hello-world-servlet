...
// for display purposes
      ...
      git 'https://github.com/success4santhi/ses-hello-world-servlet.git'
...
post {
        success {
            mail to:"noone@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"noone@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
